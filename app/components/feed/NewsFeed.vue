<template>
  <div class="flex mt-6 justify-center items-center overflow-hidden feed w-full md:w-1/3 mx-auto">
    <ul id="list-track" :class="`${state.currentCategory.slug === 'gnews' ? 'h-[63vh]' : 'h-[75vh] lg:h-[73vh]'} absolute w-[90%] top-[17%] left-[50%] transform translate-x-[-50%] lg:w-3/12 lg:top-[20%]`">
      <AnimatePresence>
        <MotionFeedNewsCard
