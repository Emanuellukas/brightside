<template>
  <div class="">
    <form @submit.prevent="searchNews" :class="`flex items-center justify-center mt-4 ${activeSearchClasses().formClasses}`">
      <input type="text" v-model="search" placeholder="Pesquisar" class="rounded-lg text-white dark:text-white text-lg font-bold px-2 py-2 h-auto mx-2 bg-transparent" />
